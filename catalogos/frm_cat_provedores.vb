...
Public Class frm_cat_provedores
    ...
    Private Sub DirectorioBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DirectorioBindingNavigatorSaveItem.Click
        ...
        If tipo_catalogo = 2 Then
            Me.Fei_clientesBindingSource.EndEdit()
            Me.Fei_clientesTableAdapter.Update(Me.FeiDataset.fei_clientes)
        End If
    ...
    Private Sub frm_cat_provedores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Fei_clientesTableAdapter.Fill(Me.FeiDataset.fei_clientes)
    ...
    Private Sub Id_directorioTextBox_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Id_directorioTextBox.TextChanged
        If Id_directorioTextBox.TextLength = 0 Then Exit Sub
        If tipo_catalogo = 2 Then
            Dim feiadap As New feiDatasetTableAdapters.fei_clientesTableAdapter

            Dim rfc As String = feiadap.validar(Me.Id_directorioTextBox.Text)
            If rfc = Nothing Then
                Me.btp_crear_fei.Visible = True
                '  If Me.RFCTextBox.TextLength < 12 Then MsgBox("Teclee un rfc valido") : Exit Sub
                'Try
                '    feiadap.Insert(Me.Id_directorioTextBox.Text, "XAXX010101000", " ", " ", " ", " ", " ", " ", " ", "", " ", "México", " ", " ", MetodoTextBox.Text, CuentaTextBox.Text, "G03")
                '    Me.Fei_clientesTableAdapter.Fill(Me.FeiDataset.fei_clientes)
                '    Me.Fei_clientesBindingSource.Position = Me.Fei_clientesBindingSource.Find("id", Me.Id_directorioTextBox.Text)
                'Catch ex As Exception
    ...
    Private Sub RFCTextBox_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RFCTextBox.TextChanged
        ...
        Me.RFCTextBox2.Text = Me.RFCTextBox.Text
    End Sub
    ...
    Private Sub Sql_documentos_clientesDataGridView_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Sql_documentos_clientesDataGridView.CellContentClick
