Class cotizaciones
    ...
    Private Sub cotizaciones_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    '    column = New DataColumn("UD_iva10", System.Type.GetType("System.Decimal"), "iif(piva<15 and piva>0,ud_vneto*" + factor_iva1_venta + ",0)")
    '    column.Caption = "*" + column.ColumnName : mytable.Columns.Add(column)

    '    column = New DataColumn("UD_iva15", System.Type.GetType("System.Decimal"), "iif(piva>14,ud_vneto*" + factor_iva2_venta + ",0)")
    '    column.Caption = "*" + column.ColumnName : mytable.Columns.Add(column)
    ...
    '    column = New DataColumn("tcosto", System.Type.GetType("System.Decimal"), "ud_costo*Cantidad")
    '    column.DefaultValue = 0 : mytable.Columns.Add(column)

    '    column = New DataColumn("empaque", System.Type.GetType("System.Decimal"))
    '    column.DefaultValue = 0 : mytable.Columns.Add(column)
    ...
    '    dgv.Columns("tcosto").Visible = False
    ...
    Sub guardar_cotizacion()
        ...
        d.a36_ieps = Math.Round(tabledoc.Rows(0).Item("ieps"), 2) '<===IEPS
    ...
    Private Sub boton_guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles boton_guardar.Click
        Windows.Forms.Cursor.Current = Cursors.WaitCursor
        guardar_cotizacion()
        My.Forms.cotizacion_relacion.imprimir(folio.Text, False)
