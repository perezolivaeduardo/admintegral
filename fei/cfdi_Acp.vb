...
Public Class cfdi_Acp
    ...
    Public Sub genera(ByVal td As Integer, ByVal serie As String, ByVal folio As Single, ByVal fcaja As Integer)
        ...
        Dim taza_cero As Boolean = False
        ...
        If impuestos.TotalImpuestosTrasladados > -1 Then
    ...
    Public Sub genera_nc(ByVal td As Integer, ByVal serie As String, ByVal folio As Single, ByVal fcaja As Integer)
        ...
        Dim timp_traslado_ieps As Decimal
        bitacora("Inicia conceptos")
        Dim tiene_tasa0 As Boolean = False
        ...
        For j As Integer = 0 To tbl.Rows.Count - 1
            ...
            If tbl.Rows(j).Item("cantidad") > 0 Then
                ...
                If tbl.Rows(j).Item("iva") > 0 Then
                    ...
                    oTraslado1Concepto1.TipoFactor = "Tasa" ' Catalogo
                    oTraslado1Concepto1.TasaOCuota = Convert.ToDecimal(0.16)
                    oTraslado1Concepto1.Importe = formato_sat(Math.Round(Convert.ToDecimal(tbl.Rows(j).Item("iva")), 2))
                    listaTrasladosConcepto1.Add(oTraslado1Concepto1)
                ...
                Else
                    ...
                    oTraslado1Concepto1.Impuesto = "002" ' IVA CATALOGO
                    oTraslado1Concepto1.TipoFactor = "Tasa" ' Catalogo
                    oTraslado1Concepto1.TasaOCuota = formato_sat(Convert.ToDecimal(0))
                    oTraslado1Concepto1.Importe = "0.00"
                    listaTrasladosConcepto1.Add(oTraslado1Concepto1)
                    tiene_tasa0 = True
                ...
                If tbl.Rows(j).Item("Vta_ieps") > 0 Then
                    ...
                    oTraslado1Concepto1.TipoFactor = "Tasa" ' Catalogo
                    oTraslado1Concepto1.TasaOCuota = Convert.ToDecimal(0.08)
                    oTraslado1Concepto1.Importe = formato_sat(Math.Round(Convert.ToDecimal(tbl.Rows(j).Item("Vta_ieps")), 2))
                    listaTrasladosConcepto1.Add(oTraslado1Concepto1)
        ...
        traslado1.TipoFactor = "Tasa"
        traslado1.TasaOCuota = Convert.ToDecimal(0.16)
        traslado1.Importe = formato_sat(Math.Round(Convert.ToDecimal(Timp_trasladado_iva), 2))
        listaTraslados.Add(traslado1)
        'End If

        ' If tiene_tasa0 Then
        Dim traslado2 As New ComprobanteImpuestosTraslado
        traslado2.Impuesto = "002" 'iva catalogo
        traslado2.TipoFactor = "Tasa"
        traslado2.TasaOCuota = "0.0000001"
        traslado2.Importe = Convert.ToDecimal(0)
        listaTraslados.Add(traslado2)
        ' End If
        ...
        If timp_traslado_ieps > 0 Then
            Dim traslado3 As New ComprobanteImpuestosTraslado
            traslado3.Impuesto = "003" 'IEPS catalogo
            traslado3.TipoFactor = "Tasa"
            traslado3.TasaOCuota = Convert.ToDecimal(0.08)
            traslado3.Importe = formato_sat(Math.Round(Convert.ToDecimal(timp_traslado_ieps), 2))
            listaTraslados.Add(traslado3)
        End If
        impuestos.Traslados = listaTraslados.ToArray()
        ...
        bitacora(comp.ToString)
        MsgBox("Guardo la bitacora")

        bitacora("manda a timbrar")
        Dim arrayLeyendas(4) As String
        ' Dim respuesta = New TimbraCFDI("http://201.131.20.62/productos/cfdi.php?wsdl").timbraCFDI(comp, "usuario_demo33", "usuario_demo33")
        Dim respuesta = New TimbraCFDI("http://gw1.acpdelsureste.net/productos/cfdi.php?wsdl").timbraCFDI(comp, dr_emisor.Item("certificado"), dr_emisor.Item("llaveprivada"), arrayLeyendas)
