...
Public Class configuracion
    Dim sql_local As String = "Data Source=LAP\SQLEXPRESS;Initial Catalog=integra;Integrated Security=True"
    ...
    Private Sub verifica_registro_comisiones()
        ...
        Catch ex As Exception
            adap.Insert(9999, 0, 0, 0, "pi", 0, 1, "Comisiones", 0, 0, 16, 0, 0, Now.Date, 0, 0, 1, 1, 1, False, False, False, 0, 0, False, 0, 0, "01010101", "H87")
