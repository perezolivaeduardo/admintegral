Public Class Kardex_express
    ...
    Private Sub id_txt_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles id_txt.KeyPress
        ...
        If e.KeyChar = chr13 Then
            ...
            cargar_proveedor() 'solo carga datos general 

            If My.Settings.pedidos_calcular = CheckState.Checked Then

                lista.Items.Add("prepara pedido")
                Preparar_pedido()
                lista.Items.Add("calcular  ventas")
                calcular_ventas()
    ...
    Private Sub cargar_proveedor()
        lista.Items.Add("cargar datos generales del proveedor")
    ...
    Private Sub Preparar_pedido()
        ...
        ''calcula y genera 
        'lista.Items.Add("borra la tabla de pz vendidas")
        'cmd = "DROP TABLE [dbo].[pz_vendidas]"
        'comando(cmd)

        'lista.Items.Add("inicia tabla unidades vendidas " + Now.TimeOfDay.ToString)
        ...
        'comando(cmd)
        'lista.Items.Add("termina tabla unidades vendidas " + Now.TimeOfDay.ToString)
        ...
        lista.Items.Add(" inicia lectura de tabla de vendidas" + Now.TimeOfDay.ToString)
        tbl = leer_tabla(cmd)
        lista.Items.Add(" termina lectura de tabla de vendidas" + Now.TimeOfDay.ToString)
        bs.Filter = ""
        ...
        tbl.Columns.Add(column)
        lista.Items.Add("Asigna tabla de unidades al grid" + Now.TimeOfDay.ToString)
        bs.DataSource = tbl
    ...
    Private Sub btn_preparar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_preparar.Click
        ...
        al = Format(fecha_al.Value, "dd-MM-yyyy")
        del = Format(fecha_del.Value, "dd-MM-yyyy")
